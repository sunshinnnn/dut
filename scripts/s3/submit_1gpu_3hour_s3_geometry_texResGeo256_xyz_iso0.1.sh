...
texResGeo="256"
expName="exp30_texResGeo${texResGeo}_iso0.1_worldLap"
echo "python train_geometry.py --lrDecayStep 1000000 --expName ${expName} \
        --weightLap 1.0 --weightIso 0.1 --weightNmlCons 0.001 --config ${config} --texResGeo ${texResGeo} --noEval --worldLap"
python train_geometry.py --lrDecayStep 1000000 \
        --expName ${expName} \
        --weightLap 1.0 --weightIso 0.1 --weightNmlCons 0.001 \
        --config ${config} \
